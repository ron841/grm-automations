      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="relative min-h-[60vh] md:min-h-[85vh] overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to top, rgba(250,248,244,0.85) 0%, rgba(250,248,244,0.45) 100%)",
            }}
          />
          <div className="absolute inset-0 flex flex-col items-end justify-center p-7 text-right md:p-12">
            ...
            <p className="max-w-[320px] font-nunito text-[15px] leading-relaxed text-grm-black/75 md:text-[16px]">
            ...
            <Link
              ...
              className="mt-5 inline-block font-nunito text-[15px] text-grm-teal no-underline transition-colors hover:underline"
            >
              Read more &rarr;
            </Link>
          </div>
        ...
        <div className="relative min-h-[60vh] md:min-h-[85vh] overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to top, rgba(0,0,0,0.82) 0%, rgba(0,0,0,0.25) 100%)",
            }}
          />
