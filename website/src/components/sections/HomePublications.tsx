      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="relative min-h-[60vh] md:min-h-[85vh] overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col justify-center p-7 md:p-12">
            ...
            <div className="mt-3">
              <span className="block font-grand-hotel text-[44px] leading-none text-grm-black md:text-[44px]">
                The
              </span>
              <span className="block font-merriweather text-[48px] font-bold leading-none text-grm-black md:text-[64px]">
                Front Porch
              </span>
            </div>
        ...
        <div className="relative min-h-[60vh] md:min-h-[85vh] overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col items-end justify-center p-7 text-right md:p-12">
            ...
            <div className="mt-3">
              <span className="block text-right font-grand-hotel text-[44px] leading-none text-white md:text-[44px]">
                The
              </span>
              <span className="block text-right font-merriweather text-[48px] font-bold leading-none text-white md:text-[64px]">
                Closing Table
              </span>
            </div>
